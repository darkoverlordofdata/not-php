...
var CASE_LOWER, CASE_UPPER, PATHINFO_BASENAME, PATHINFO_DIRNAME, PATHINFO_EXTENSION, PATHINFO_FILENAME, array_keys, array_merge, array_merge_recursive, class_exists, count, createRegExp, crypto, file_exists, format, fs, function_exists, get_class, ip2long, ltrim, method_exists, path, querystring, register_class, rtrim, stripslashes, url, util, __pop, __push,
  __slice = [].slice;
...
exports["export"] = function($scope, $extra) {
  var $body, $defaults, $name, _ref;
  if ($scope == null) {
    $scope = global;
  }
  if ($extra == null) {
